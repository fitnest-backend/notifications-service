...
public class CustomerSubscriptionQueryServiceImpl implements CustomerSubscriptionQueryService {
    ...
    @Override
    public JsonNode getCustomerSubscription(Long customerId) {
        try {
            ...
            return WebClient.builder()
                    ...
                    .build()
                    .get()
                    .uri("/api/v1/admin/customers/{customerId}/subscription", customerId)
                    .headers(h -> {
