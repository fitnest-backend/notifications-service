...
public class LocalizedBroadcastServiceImpl implements LocalizedBroadcastService {
    ...
    @Override
    public int broadcast(Map<String, LocalizedContent> contentsByLanguage, Map<String, String> data) {
        ...
        // Device-first: only users who can actually receive push (current + notifications enabled)
